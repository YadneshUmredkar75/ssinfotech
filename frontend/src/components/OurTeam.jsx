...
export default function OurTeam() {
  return (
    <section className="text-center space-y-4 py-5 rounded-4xl">
      <h2 className="text-3xl font-bold text-[#AB1EA9]">Meet the Team</h2>
      <p className="text-gray-600 max-w-2xl mx-auto">
        Our strength lies in our people. From educators and trainers to developers,
        marketers, and visionary leaders – each member contributes to delivering
